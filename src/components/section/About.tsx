          ...
          <div className="flex flex-col md:flex-row justify-between items-start max-w-6xl mx-auto gap-8">
            <div className="text-left w-full md:w-auto">
              <div className="ascii-container justify-start text-3xl md:text-4xl lg:text-5xl">
                <AsciiMorphText text="Hi, I'm Lillya Maria" />
              </div>
      ...
      <div className="w-full md:max-w-2xl lg:max-w-4xl relative z-20 px-1 md:px-0">
        ...
        <div className="absolute left-[13%] top-[28%] w-[26%] md:left-[12%] md:top-[26%] md:w-[24%] z-30">
          <img
            src={profile1}
            alt="Profile"
            className="w-full rounded-sm object-cover shadow-md rotate-[-5deg]"
          />
        </div>
        ...
        <div className="absolute right-[8%] top-[16%] w-[38%] md:right-[9%] md:top-[14%] md:w-[34%] z-30 text-left">
          ...
          >
            ...
            <br />
            <br />
            I’m always curious, always learning, and I love discovering small details that make a project feel more personal and alive.
            <br />
            <br />
            Outside coding, I love paiting, kpop, poetry, animations and collecting cute
            inspirations!
          </p>
        </div>
      </div>
